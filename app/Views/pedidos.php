...
<div class="container2">
    ...
    <div class="filter-container">
        ...
        <select id="filterEstado">
            ...
            <option value="Asignando Domciliario">Asignando Domciliario</option>
        ...
        <div class="cards-container" id="pedidoCards">
            <?php foreach ($pedidosAgrupados as $id_pedido => $pedidoGroup): ?>
                <div class="card-main" data-id="<?= $id_pedido ?>" data-estado="<?= htmlspecialchars($pedidoGroup[0]['estado']) ?>">
                    ...
                    <?php if ($pedidoGroup[0]['estado'] !== 'Cancelado'): ?>
...
<script>
    ...
    function cancelarPedido(idPedido) {
        if (confirm('¿Estás seguro de que deseas cancelar este pedido?')) {
            ...
            // Esperamos a que termine la animación para hacer la solicitud
            botonCancelar.addEventListener('animationend', () => {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        // Eliminar la tarjeta del pedido cancelado
                        const card = document.querySelector(`.card-main[data-id="${idPedido}"]`);
